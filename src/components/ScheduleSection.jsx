...
const ScheduleSection = ({ formData, workoutSchedule, setWorkoutSchedule }) => {
    ...
    return (
        <div className="w-full max-w-lg">
            ...
            <h2 className="text-xl font-bold text-center mb-4 m-auto w-fit gradient-text-blue">{formData.name}'s Weekly Workout Schedule</h2>
                    ...
                    return (
                        <div key={index} className="border-b last:border-b-0 pb-4 mt-4 flex justify-between">
                            ...
                            <div className="ml-6 text-sm text-gray-500">
                                {Array.isArray(workout) ? (
                                    <div>
                                        <h4 className="text-base font-semibold mb-1 text-gray-500 dark:text-gray-400">Muscles Targeted:</h4>
