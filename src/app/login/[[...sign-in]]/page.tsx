          ...
          <SignIn
            ...
            appearance={{
              ...
              elements: {
                ...
                formButtonPrimary:
                  'bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition-all duration-200',
                footerActionLink:
              ...
              variables: {
                ...
                colorBackground:
                  resolvedTheme === 'dark' ? '#101828' : '#f9fafb',
